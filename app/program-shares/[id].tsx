...
const s = StyleSheet.create({
  ...
  card: { borderRadius: 16, padding: 16, marginBottom: 12, borderWidth: 1, gap: 14 },
  ...
  metaLabel: { fontFamily: Fonts.medium, fontSize: 12.5 },
  metaVal: { fontFamily: Fonts.semibold, fontSize: 12.5, marginLeft: 'auto' },
