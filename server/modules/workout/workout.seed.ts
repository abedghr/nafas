...
const TIME_HOLD = new Set([
  ...
  "Hollow Body Hold",
  "Chin-Over-Bar Hold", "Bottom Pull-up Hold", "Dip Support Hold", "90° Dip Hold",
  "Ring Support Hold", "Tuck Planche Hold", "Frog Stand", "Copenhagen Plank",
  "Chin-up Negative Hold", "Wall Handstand Hold",
]);
