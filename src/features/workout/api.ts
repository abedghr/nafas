...
export const workoutApi = {
  ...
  setEnrollmentDay: (id: string, body: { weekIndex: number; dayIndex: number; status: "done" | "skipped"; completedDate?: string | null; durationMin?: number | null; logId?: string | null }) =>
